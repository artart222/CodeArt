...
function M.make_codeart_transparent()
  ...
  highlight("NeoTreeNormal", { bg = "NONE", fg = "NONE", ctermbg = "NONE", ctermfg = "NONE" })
  highlight("NeoTreeNormalNC", { bg = "NONE", fg = "NONE", ctermbg = "NONE", ctermfg = "NONE" })
  highlight("NeoTreeEndOfBuffer", { bg = "NONE", fg = "NONE", ctermbg = "NONE", ctermfg = "NONE" })
  highlight("NeoTreeDirectoryIcon", { bg = "NONE", fg = "NONE", ctermbg = "NONE", ctermfg = "NONE" })
  highlight("NeoTreeDirectoryName", { bg = "NONE", fg = "NONE", ctermbg = "NONE", ctermfg = "NONE" })
